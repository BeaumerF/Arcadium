...
// Last update Sun Apr  9 17:32:33 2017 François Beaumer
//
...
extern "C" 
{
  ...
  void load_lib()
  {
    printf("Loading menu graph openGL\n");
  }

  void close_lib()
  {
    printf("Unloading menu graph openGL\n");
  }
  ...
  void        display_menu_graph(int choice)
  {
    int image;
    ...
    glLoadIdentity( );
    glTranslated(183, 221, 0);
    if (choice == 0)
      drawSelect(367, 60, 255, 255, 255);
    drawBeveledSquare(367, 60, 123, 15, 213);
    drawStrokeText("SDL", 140, 15 ,0);
    glTranslated(0, 80, 0);
    if (choice == 1)
      drawSelect(367, 60, 255, 255, 255);
    drawBeveledSquare(367, 60, 213, 173, 53);
    drawStrokeText("openGL", 100, 15, 0);
    glTranslated(0, 80, 0);
    if (choice == 2)
      drawSelect(367, 60, 255, 255, 255);
    drawBeveledSquare(367, 60, 23, 92, 13);
    drawStrokeText("Ncurses", 80, 15, 0);
    glFlush();
    SDL_GL_SwapBuffers();
  }
